...
router.post('/create',  checker, testing, multer, list, toPublicationFunction.createPublication); //multer après authentification pour éviter enregitrement images inutiles
